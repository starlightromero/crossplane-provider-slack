...
func (u *UserGroup) GetPublishConnectionDetailsTo() *xpv1.PublishConnectionDetailsTo {
	return u.Spec.PublishConnectionDetailsTo
}

// SetPublishConnectionDetailsTo sets the publish connection details reference.
func (u *UserGroup) SetPublishConnectionDetailsTo(ref *xpv1.PublishConnectionDetailsTo) {
