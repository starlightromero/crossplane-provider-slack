...
func (c *ConversationPin) GetManagementPolicies() xpv1.ManagementPolicies {
	return c.Spec.ManagementPolicies
}

// SetManagementPolicies sets the management policies.
func (c *ConversationPin) SetManagementPolicies(p xpv1.ManagementPolicies) {
	c.Spec.ManagementPolicies = p
}

// GetDeletionPolicy returns the deletion policy.
func (c *ConversationPin) GetDeletionPolicy() xpv1.DeletionPolicy {
	return c.Spec.DeletionPolicy
}

// SetDeletionPolicy sets the deletion policy.
func (c *ConversationPin) SetDeletionPolicy(p xpv1.DeletionPolicy) {
